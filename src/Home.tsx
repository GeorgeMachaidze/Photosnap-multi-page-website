...
import firstImageTablet from "./assets/home/tablet/create-and-share.jpg";
import rectangleTablet from "./assets/home/tablet/rectangleTablet.png";
import secondImageTablet from "./assets/home/tablet/beautiful-stories.jpg";
import thirdImageTablet from "./assets/home/tablet/designed-for-everyone.jpg";
import firstImageDesktop from "./assets/home/desktop/create-and-share.jpg";
import secondImageDesktop from "./assets/home/desktop/beautiful-stories.jpg";
import thirdImageDesktop from "./assets/home/desktop/designed-for-everyone.jpg";

function Home() {
  return (
    <div>
      <div className="md:flex">
        <img className="md:hidden" src={firstImage} alt="" />
        <div className="bg-black pl-[33px] pr-[24px] pb-[72px] md:flex md:flex-col md:justify-center lg:p-0">
          <img className="md:hidden" src={rectangle} alt="" />
          <img
            className="hidden md:block absolute w-[6px] ml-[-33px] lg:ml-0"
            src={rectangleTablet}
            alt=""
          />
          <p className="mt-[66px] mb-[18px] font-bold text-[32px] font-sans tracking-widest leading-[40px] text-white md:mt-0 md:text-[40px] md:tracking-[4.16px] md:leading-[48px] lg:ml-[111px] lg:mr-[111px]">
            CREATE AND SHARE YOUR PHOTO STORIES.
          </p>
          <p className="text-white opacity-40 mb-[23px] font-sans leading-[25px] lg:ml-[111px] lg:mr-[111px]">
            Photosnap is a platform for photographers and visual storytellers.
            We make it easy to share photos, tell stories and connect with
            others.
          </p>
          <div className="flex flex-row  lg:ml-[111px] lg:mr-[111px] cursor-pointer">
      ...
      <div>
        <img className="md:hidden" src={secondImage} alt="" />
        <div className=" pl-[33px] pr-[24px] pb-[72px] md:p-0 md:flex md:items-center">
          <img
            className="hidden md:block lg:hidden"
          ...
          <img
            ...
            alt=""
          />
          <div className="md:flex md:flex-col md:ml-[54px] md:mr-[54px]">
            <p className="mt-[66px] mb-[18px] font-bold text-[32px] font-sans tracking-[3.33px] leading-[40px] w-[318px] md:text-[40px] md:leading-[48px] ">
              BEAUTIFUL STORIES <br /> EVERY TIME
            </p>
            <p className=" opacity-60 mb-[23px] font-sans leading-[25px] md:text-[15px]">
            ...
            <div className="flex flex-row cursor-pointer ">
              <p className="font-sans leading-[16px] text-[12px] tracking-[2px] font-bold hover:underline">
                VIEW THE STORIES
              </p>
              <img
                className="h-[12px] mt-[2px] ml-[18px]"
      ...
      <div>
        <img className="md:hidden" src={thirdImage} alt="" />
        <div className=" pl-[33px] pr-[24px] pb-[72px] md:p-0 md:flex md:items-center">
          <div className="md:flex md:flex-col md:ml-[54px] md:mr-[54px]">
          ...
          <img
            ...
            alt=""
          />
          <img className="hidden lg:block" src={thirdImageDesktop} alt="" />
        </div>
      </div>
        ...
        <div className="md:flex lg:w-[50%]">
          <div className="w-[375px] h-[375px] relative md:w-[50%]  md:h-[500px] md:bg-cover bg-[url('./assets/stories/mobile/mountains.jpg')]  md:bg-[url('./assets/stories/desktop/mountains.jpg')] hover:translate-y-[-20px] hover:border-b-8 hover:border-b-fuchsia-800">
            <div className="pl-[33px] pr-[24px] relative z-10 ">
              <h1 className="font-sans text-6 font-bold text-white text-[18px] leading-[25px] pt-[236px] md:pt-[340px] ">
                The Mountains
              </h1>
      ...
      <div className="mt-20 pb-20 pl-[33px] pr-[33px] md:pl-[155px] md:pr-[155px] md:mt-[120px] md:pb-[120px] lg:flex lg:items-center lg:gap-[30px]">
        <div className="flex flex-col items-center lg:mt-0">
          ...
          <h1 className="text-4 font-bold font-sans mt-[48px]">
            100% Responsive
          </h1>
          <p className="text-center text-[15px] opacity-60 mt-3">
            No matter which the device you’re on, our site is fully responsive
            and stories look beautiful on any screen.
          </p>
        </div>
        <div className="flex flex-col items-center mt-[56px] lg:mt-0">
          <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72">
        ...
        <div className="flex flex-col items-center mt-[56px] md:mt-[80px] lg:mt-0">

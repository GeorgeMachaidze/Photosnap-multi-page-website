  ...
  return (
    <div>
      <div className="md:flex">
        ...
        <div className="bg-black pl-[33px] pr-[24px] pb-[72px] md:flex md:flex-col md:justify-center">
          <img className="md:hidden" src={rectangle} alt="" />
          <img
            className="hidden md:block absolute w-[6px] ml-[-33px]"
            src={rectangleTablet}
            alt=""
          />
          <p className="mt-[66px] mb-[18px] font-bold text-[32px] font-sans tracking-widest leading-[40px] text-white md:mt-0 md:text-[40px] md:tracking-[4.16px] md:leading-[48px]">
        ...
        <img className="hidden md:block" src={firstImageTablet} alt=""></img>
      </div>
      <div>
        <img className="md:hidden" src={secondImage} alt="" />
        <div className=" pl-[33px] pr-[24px] pb-[72px] md:p-0 md:flex md:items-center">
          <img className="hidden md:block" src={secondImageTablet} alt="" />
      ...
      <div>
        ...
        <div className=" pl-[33px] pr-[24px] pb-[72px] md:p-0 md:flex md:items-center">
          ...
          <img className="hidden md:block" src={thirdImageTablet} alt="" />
        </div>
      </div>
      <div className="md:flex">
        <div
          className="w-[375px] h-[375px] relative md:bg-cover md:hidden"
        ...
        <div
          className="relative hidden md:flex md:w-[384px] md:h-[500px] bg-cover"
          style={{ backgroundImage: `url(${mountainsTablet})` }}
        >
          <div className="pl-[33px] pr-[24px] z-40 relative ">
            <h1 className="font-sans text-6 font-bold text-white text-[18px] leading-[25px] pt-[361px] z-10 ">
              The Mountains
            </h1>
            <p className="mt-[1px] font-sans text-[13px] leading-[18px]  text-white ">
              by John Appleseed
        ...
        <div
          ...
          style={{ backgroundImage: `url(${newYorkTablet})` }}
        >
          <div className="pl-[33px] pr-[24px] relative z-10 ">
      ...
      <div className="md:flex">
        <div
          className="w-[375px] h-[375px] relative md:hidden"
        ...
        <div
          className="w-[375px] h-[375px] relative hidden md:flex md:w-[50%] md:h-[500px] md:bg-cover"
          style={{ backgroundImage: `url(${voyageTablet})` }}
        >
          <div className="pl-[33px] pr-[24px] relative z-10 ">
            <h1 className="font-sans text-6 font-bold text-white text-[18px] leading-[25px] pt-[361px]">
              18 Days Voyage
      ...
      <div className="mt-20 pb-20 pl-[33px] pr-[33px] md:pl-[155px] md:pr-[155px] md:mt-[120px] md:pb-[120px]">
        ...
        <div className="flex flex-col items-center mt-[56px] md:mt-[80px]">

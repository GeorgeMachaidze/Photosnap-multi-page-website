    ...
    <>
      <div>
        <div className="md:flex">
          ...
          <img className="md:flex hidden" src={heroTablet} alt="" />
        </div>
        <div className="pt-[64px] pb-[91px] pl-[33px] pr-[24px]">
          <div className="hidden md:flex">
            <div className="flex flex-col items-center">
              ...
              <h1 className="font-sans font-bold text-[18px] leading-[25px] mt-12">
                100% Responsive
              </h1>
              <p className="font-sans text-[15px] text-center opacity-60 mt-4 leading-[25px]">
                No matter which the device you’re on, our site is fully
                responsive and stories look beautiful on any screen.
              </p>
            </div>
            <div className="flex flex-col items-center mt-[56px] md:mt-9">
